...
!************************ SUBROUTINE LINBAS ****************************
!
! the call has the same interface as ZGEMM except
...
# 305
      ...
      IF (TRANSB=='N' .OR. TRANSB=='n') THEN
         CALL ZGEMM( TRANSA, TRANSB, N1,  PGEMM_HANDLE%NCOL( PGEMM_HANDLE%COMM%NODE_ME), N3, ALPHA, A, LDA, &
...
! but this (1._q,0._q) allows for a different leading dimension NDIM
