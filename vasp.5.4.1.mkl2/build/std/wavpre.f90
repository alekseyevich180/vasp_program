...
! work arrays
      ...
      COMPLEX(q),ALLOCATABLE :: CPRO0(:),CPRO1(:),CPROL(:)
...
!-----------------------------------------------------------------------
      CALL ZGEMM( 'C', 'N', WDES%NBANDS, WDES%NBANDS, WDES%NBANDS, (1._q,0._q), CU, WDES%NBANDS, &
     &            CU, WDES%NBANDS, (0._q,0._q), CAP, WDES%NBANDS)
!-----------------------------------------------------------------------
...
! caclulate AP(N,M)=A(N,K)*CONJG(U(M,K))
      CALL ZGEMM( 'N', 'C', WDES%NBANDS, WDES%NBANDS, WDES%NBANDS, (1._q,0._q), CA, WDES%NBANDS, &
     &            CU, WDES%NBANDS, (0._q,0._q) , CAP, WDES%NBANDS)
!-----------------------------------------------------------------------
...
! CU(N,M)=CONJG(CAP(K,N))*CA(K,M)
      ...
      CALL ZGEMM('C', 'N', WDES%NBANDS, WDES%NBANDS, WDES%NBANDS, (1._q,0._q), CAP, WDES%NBANDS, &
     &             CA, WDES%NBANDS, (0._q,0._q) , CU, WDES%NBANDS)
!=======================================================================
...
!-----------------------------------------------------------------------
      ...
      WFMAGLL=WFMAGL
      IF (LOVERL) THEN
      WFMAG =WFMAG + REAL( ZDOTC( WDES%NPRO,W%CPROJ(1,N,NK,ISP),1,CPRO0,1) ,KIND=q)
      WFMAGL=WFMAGL+ REAL( ZDOTC( WDES%NPRO,CPROL            ,1,CPRO0,1) ,KIND=q)
      ENDIF
