...
!***********************************************************************
      ...
      REAL(q)  CHDENR(GRID%RL%NP),CHMAGR(GRID%RL%NP)
      REAL(q)  DENCOR(GRID%RL%NP)
      REAL(q)  CVXC1(GRID%RL%NP),CVXC2(GRID%RL%NP)
...
!=======================================================================
      IF (IMAX>EXCTAB%NEXCHF(2)*.96_q) THEN
        IF (NODE_ME==IONODE) WRITE(*,*)'ERROR FEXCF: supplied exchange-correlation table'
