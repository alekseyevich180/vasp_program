...
!***********************************************************************
  ...
  SUBROUTINE LHF(HAMILTONIAN,GRID, GRID_SOFT, LATT_CUR, SYMM, T_INFO, INFO, &
    ...
    REAL(q),TARGET :: CRHODE(LMDIM,LMDIM,WDES%NIONS,WDES%NCDIJ) ! (1._q,0._q) center occupancy matrix
    REAL(q) CDIJ(LMDIM,LMDIM,WDES%NIONS,WDES%NCDIJ)   ! (1._q,0._q) centre strenght parameters of potentials
...
! if SWITCH_TO_OEP is selected the on site terms
    ...
    REAL(q) CDIJC(LMDIM,LMDIM,WDES%NIONS,WDES%NCDIJ)  ! (1._q,0._q) centre correction
    REAL(q) CRHODE_CORR(LMDIM,LMDIM,WDES%NIONS,WDES%NCDIJ)! (1._q,0._q) centre occupancies to correct potential
