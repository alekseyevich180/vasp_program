...
double MEMORY_FP = 0.0;
double CURRENT_MAX_MEMORY_FP = 0.0;
unsigned long long int MAX_MEMORY = 0;
...
int CUBLAS_SET_VECTOR_ASYNC (const int *n, const int *elemSize, const void *x,
                             const int *incx, const devptr_t *y, const int *incy);
int CUBLAS_SET_VECTOR_ST (const int * StreamIdx, const int *n, const int *elemSize, const void *x,
                             const int *incx, const devptr_t *y, const int *incy);
...
int CUBLAS_GET_VECTOR_ASYNC (const int *n, const int *elemSize, const devptr_t *x,
                             const int *incx, void *y, const int *incy);
int CUBLAS_GET_VECTOR_ST (const int * StreamIdx, const int *n, const int *elemSize, const devptr_t *x,
                             const int *incx, void *y, const int *incy);
int CUBLAS_GET_VECTOR_SH_ASYNC (const int *n, const int *elemSize, const devptr_t *x,const int * shift,
                                const int *incx, void *y, const int *incy);
int CUBLAS_GET_VECTOR_SH (const int *n, const int *elemSize, const devptr_t *x,const int * shift,
                          const int *incx, void *y, const int *incy);
...
int CUBLAS_SET_MATRIX (const int *rows, const int *cols, const int *elemSize,
                       ...
                       const int *ldb);
int CUBLAS_SET_MATRIX_SHIFT (const int *rows, const int *cols, const int *elemSize,
                             const void *A, const int *lda, const devptr_t *B, const int *shiftB,
                             const int *ldb);
int CUBLAS_SET_MATRIX_ASYNC (const int * StreamIdx, const int *rows, const int *cols, const int *elemSize,
                       const void *A, const int *lda, const devptr_t *B, 
                       const int *ldb);

int cublas_set_matrix_shift_async_(const int * StreamIdx, const int *rows, const int *cols, const int *elemSize,
		                   const void *A, const int *lda, const devptr_t *B, const int *shiftB,
				   const int *ldb);
...
int CUBLAS_GET_MATRIX_SHZ (const int *rows, const int *cols, const int *elemSize,
                           const devptr_t *A, const int * shiftA, const int *lda, void *B, const int *ldb);
/* BLAS util */
