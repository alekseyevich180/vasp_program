...
# 132
          ...
          CALL M_sum_z(WDES%COMM_KINTER, CHARGE_REAL_SPACE%RG(1,I),CHARGE_REAL_SPACE%GRID%RL%NP)
...
# 369
         ...
         CALL M_sum_z(WDES%COMM_INTER, CDWORK(1,I), GRID%RL%NP)
         CALL M_sum_z(WDES%COMM_KINTER, CDWORK(1,I), GRID%RL%NP)
