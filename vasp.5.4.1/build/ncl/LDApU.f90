...
!***********************************************************************
      ...
      COMPLEX(q) , PRIVATE, ALLOCATABLE :: OCC_MAT(:,:,:)
      COMPLEX(q) , PRIVATE, ALLOCATABLE :: OCC_MAT_ALL(:,:,:,:)
...
! LDAUL   l-quantum number on which U acts ((1._q,0._q) value for each species)
...
!**********************************************************************
      ...
      COMPLEX(q) CRHODE(LMDIM,LMDIM,NCDIJ) ! occupancy matrix
      COMPLEX(q) CDIJ(LMDIM,LMDIM,NCDIJ)   ! strength parameters
...
!**********************************************************************
      ...
      COMPLEX(q) CRHODE(LMDIM,LMDIM,NCDIJ)
      COMPLEX(q) CDIJ(LMDIM,LMDIM,NCDIJ)
      ...
      COMPLEX(q) POT_U(LMDIM,LMDIM,NCDIJ),TMP
...
!**********************************************************************
      ...
      COMPLEX(q) POT_U(LMDIM,LMDIM,NCDIJ)
...
# 1544
      ...
      CALL M_sum_d( WDES%COMM, OCC_MAT_ALL, 2*LMMAX_*LMMAX_*NCDIJ*NIONS)
