...
! currently only (1._q,0._q) fixed value for
!   RSMOOTH is allowed
...
! (1._q,0._q) is the derivative of the projector
!
!***********************************************************************
...
! this subroutine calculates a linear combination of
! projection operatores in real space
! the only difference is the CRACC is defined as COMPLEX(q) whereas it is
...
!
! exact copy of the previous routine with CRACC defined as COMPLEX(q)
