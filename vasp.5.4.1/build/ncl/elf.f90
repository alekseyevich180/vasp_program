...
! dynamic work arrays
      ...
      COMPLEX(q),     ALLOCATABLE :: CDWORK(:),CNEW(:)
...
! thats it. 20010606 Robin Hirschl
      ...
      ALLOCATE(CDWORK(MPLWV),CNEW(MPLWV), &
               CR(MPLWV),CR2(MPLWV))
...
# 87
      ...
      CALL M_sum_z(WDES%COMM_INTER, CDWORK(1), GRID%RL%NP)
...
!=======================================================================
      ...
      COMPLEX(q) CHDEN(GRID%RL%NP),CKINE(GRID%RL%NP),CGRDSQ(GRID%RL%NP)
      COMPLEX(q) LAPLAC(GRID%RL%NP)
!=======================================================================
