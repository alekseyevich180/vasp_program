...
! charge-density and potential on soft grid
      ...
      COMPLEX(q)       SV(GRID2%MPLWV,WDES%NCDIJ)
! density of states
...
! are evaluated without the (1._q,0._q)-center Fock contributions
...
! (1._q,0._q) last time to get the self-consistent Hamiltonian matrix
      IF (LHAM) THEN
         IFLAG=1
