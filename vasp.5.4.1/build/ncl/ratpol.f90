...
! probably the simplest algorithm (1._q,0._q) can come up with.
! it uses a damped second order equation
! I think (1._q,0._q) needs to set up the inverse of the Hessian
...
! local
      ...
      NCALL=NCALL+1
      N=2
! occupied state only add (1._q,0._q) more pole above Fermi-level
