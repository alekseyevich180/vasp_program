...
!   a given lattice. In principle (1._q,0._q) has 3*N degrees of freedom for a *
...
!   is currently only (1._q,0._q) drawback of this routine: even if (1._q,0._q) has no *
...
! Transfer result back to D, FD, and ST and take cartesian representation ... :
     ...
     &                                       AD(1,1,IA),AFD(1,1,1,1,IA),AST(1,1,1,IA))
      ...
      USE sym_prec
      IMPLICIT REAL(q) (A-H,O-Z)
! Check whether (1._q,0._q) found some new independent direction and
