...
!   In principle < phi | S |phi> should have only non (0._q,0._q) elements
...
! redistribute everything
          ...
          CALL M_sum_z(W%WDES%COMM_INTER,CHAM(1,1),NB_TOT*NB_TOT)
!=======================================================================
...
! divide by number of symmetry operations
          ...
          IF (WDES1%NPL_RED/=0) &
               CALL ZGEMM('N', 'N',  WDES1%NPL_RED, NB_TOT, NB_TOT, SCALE, &
               &               WS%CPTWFP(1,1),  WDES1%NRPLWV_RED, CHAM(1,1), &
               &               NB_TOT, (1._q,0._q), WACC_NEW%CPTWFP(1,1),  WDES1%NRPLWV_RED)
          IF (WDES1%NPRO_RED/=0 .AND. LPROJ ) &
               CALL ZGEMM('N', 'N', WDES1%NPRO_RED, NB_TOT, NB_TOT, SCALE, &
               &               WS%CPROJ(1,1), WDES1%NPROD_RED, CHAM(1,1), &
               &               NB_TOT, (1._q,0._q), WACC_NEW%CPROJ(1,1), WDES1%NPROD_RED)
    ENDDO
! redistribute back
    IF (W%WDES%DO_REDIS) THEN
