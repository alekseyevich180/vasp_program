...
! overwrite initial communicator by new 1._q
      COMM=COMM_CART
...
! initiate the receive from node-1 (note 0._q based)
...
! initiate the send
         i = MOD(COMM%NODE_ME-1+1 , COMM%NCPU)  ! i 0._q based
...
! only 1._q simple MPI_alltoall is required
...
!----------------------------------------------------------------------
!
! M_sumf_d: performs a fast global sum on n complex in
