...
! 0._q all elements on the grid gK 021206
!DIR$ IVDEP
!OCL NOVREC
      DO M=1,GRID%NGX_rd*GRID%NGY_rd*GRID%NGZ_rd
         CR(M)=(0.0_q,0.0_q)
      ENDDO
! old version to 0._q all elements
!     DO M=1,GRID%NPLWV
!        CR(M)=(0.0_q,0.0_q)
!     ENDDO
! now fill in non 0._q elements from
...
!* the end of the 'config.h' file where you define *1._q* of the the conv-*
