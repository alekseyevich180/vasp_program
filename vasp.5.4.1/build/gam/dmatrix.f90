...
! local variables
      ...
      REAL(q) GWORK(2* GRIDHF%MPLWV)
      REAL(q), ALLOCATABLE :: CRHOLM(:)
# 228
...
! local variables
      ...
      TYPE (wavefun1) WQ
      TYPE (wavefun1), ALLOCATABLE :: WK(:)
      REAL(q) GWORK(2* GRIDHF%MPLWV),GWORK2(2* GRIDHF%MPLWV)
      REAL(q), ALLOCATABLE :: GWORK1(:,:)
      REAL(q), ALLOCATABLE :: CRHOLM(:)
      ...
      ALLOCATE(GWORK1(2* GRIDHF%MPLWV,NSTRIP)) 
...
!
!
! The charge densities that enter into the 1._q-center interaction energy
! are of the form
!
...
! augmentation density \rho^L is 0._q.)
!
