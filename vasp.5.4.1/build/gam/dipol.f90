...
!    1._q also had to add a contribution from the equivalent position at the
!    opposite cell boundary (position +0.5) effectively adding up to 0._q
...
! usually 1._q must use the calling interface CDIPOL_CHTOT_REC
...
! this is the value for the cubic super cell should be equal EDIPOL
      ELSE
!
! interested in limit of very long cell in 1._q direction
