...
! 0._q all elements in EFG_RAD that have not been
...
! 0._q, set the hartree potential at G=0 to 0._q.
!=======================================================================
...
! x,y,z components and norm of G vector
         ...
         EFG_PW(1,NI)=EFG_PW(1,NI)-FACTM* CWORK(I)*(GX*GX-GSQU/3)
         EFG_PW(2,NI)=EFG_PW(2,NI)-FACTM* CWORK(I)*(GY*GY-GSQU/3)
         EFG_PW(3,NI)=EFG_PW(3,NI)-FACTM* CWORK(I)*(GZ*GZ-GSQU/3)
         EFG_PW(4,NI)=EFG_PW(4,NI)-FACTM* CWORK(I)*(GX*GY)
         EFG_PW(5,NI)=EFG_PW(5,NI)-FACTM* CWORK(I)*(GX*GZ)
         EFG_PW(6,NI)=EFG_PW(6,NI)-FACTM* CWORK(I)*(GY*GZ)
