...
! the value are brought continously to 0._q at the end of the interval
!-----------------------------------------------------------------------
      IF (LAUTO) THEN
        NZERO=0
...
! damp out the last NZERO values
      IF (NZERO /=0 ) THEN
! to reduce termination ripples lead smoothly to 0._q
!         NZER=NZERO
!         NZ=NQNL-NZER
!         DO N=NZ,NQNL
...
!  on the sphere boundary the Besselfunctions are 0._q
...
!  for the first point 0._q derivative is assumed
