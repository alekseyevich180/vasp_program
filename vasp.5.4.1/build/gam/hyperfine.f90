...
! 0._q 1._q-center contributions that
...
! The following allows an additional round-robin distribution over COMM_KINTER as well.
            ...
            ENDIF
         ENDDO
! communicate 1._q-center contributions (is not 1._q in SET_DD_PAW)
...
! isotropic (Fermi contact) contribution
            HYPERFINE_PW_ISO(NI)=HYPERFINE_PW_ISO(NI)+FACTM* CHTOT(I)*CGR
...
! anisotropic (dipolar) contribution
               HYPERFINE_PW_ANI(1,NI)=HYPERFINE_PW_ANI(1,NI)+FACTM* CHTOT(I)*(GX*GX/GSQU-1._q/3._q)*CGR
               HYPERFINE_PW_ANI(2,NI)=HYPERFINE_PW_ANI(2,NI)+FACTM* CHTOT(I)*(GY*GY/GSQU-1._q/3._q)*CGR
               HYPERFINE_PW_ANI(3,NI)=HYPERFINE_PW_ANI(3,NI)+FACTM* CHTOT(I)*(GZ*GZ/GSQU-1._q/3._q)*CGR
               HYPERFINE_PW_ANI(4,NI)=HYPERFINE_PW_ANI(4,NI)+FACTM* CHTOT(I)*(GX*GY/GSQU)*CGR
               HYPERFINE_PW_ANI(5,NI)=HYPERFINE_PW_ANI(5,NI)+FACTM* CHTOT(I)*(GX*GZ/GSQU)*CGR
               HYPERFINE_PW_ANI(6,NI)=HYPERFINE_PW_ANI(6,NI)+FACTM* CHTOT(I)*(GY*GZ/GSQU)*CGR
            ENDIF
         ENDDO ions
