...
! band blocking in RMM-DIIS and Davidson (and some other subroutines)
      NSIM=4
! deep iterations, do only few bands in 1._q go
...
! 1._q might wish to change them artificially (--> for example trying
...
! 1._q finds 'optimization flag' then set LREAL=.TRUE., else .FALSE.)
      LREAL=.FALSE.
...
! Pullay pressure (1._q could also say external pressure), default 0.
      PSTRESS=0._q
...
! if 1._q request the Hartree potential LVHAR supercedes the LVTOT
...
! 1._q, hence we can switch it off
