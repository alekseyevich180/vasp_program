...
! position for 1._q l,m ,lp,mp  quadruplet
...
!       the integrals which are not 0._q are stored in YLM3
!       (see YLM3LOOKUP)
! JS    stores for each integral stored in YLM3 the
!       the corresponding L and M index
! to transform 1._q l,lp part of an array organized as
...
!OCL NOVREC
      ...
      ENDDO
!-----------------------------------------------------------------------
! initialize all componentes L>2 to 0._q
!-----------------------------------------------------------------------
      IF (LYDIM <3) GOTO 100
      LSET=2
...
!
! to obtain the final gradient 1._q has to use
!
