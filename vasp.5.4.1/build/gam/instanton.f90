...
!              head=im+1
!              IF (im == nim) head=1
!! Is Rim the correct 1._q to use here ?!?    -> Yes, it is the most current coordinate.
!              dx=Rim(:,:,head)-Rim(:,:,im)
!              CALL mic(dx,ntot)
!              fs0(im)=0.0_q
!              k=0
...
! skip the next 1._q ... it SHOULD be 0._q but isn't ... lets pretend it is !!!
