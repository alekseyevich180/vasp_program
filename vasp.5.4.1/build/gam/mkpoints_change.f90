...
! 1._q k-points mesh to another k-point mesh
...
!  from 1._q k-point grid in the IRZ to another 1._q
...
! reuse old k-point, since the new 1._q might be shifted by a unit vector
...
! the data layout is identical to the original 1._q
!
!*********************************************************************
...
!
! now allocate the new wavefunction array and 0._q it
!
    ...
    DO ISP=1,WDES%ISPIN
       DO NK=1,WDES%NKPTS          
          ...
          DO N=1,WDES%NBANDS
             DO ISPINOR=0,WDES%NRSPINORS-1
                ...
                DO NT=1, WDES%NTYP
                   DO NI=NIS, WDES%NITYP(NT)+NIS-1
                      ...
                      CALL ROTATE_VECTOR( PKPOINTS_TRANS%LINV(NK),W%GPROJ(NPROP,N,NK_OLD,ISP_OLD),W_NEW%GPROJ(NPRO,N,NK,ISP),ROT_HANDLE%MMAX,ROT_HANDLE%LDIM,ROT_HANDLE%SL(1,1,0),P(NT))
             ...
             CALL ROTATE_WAVE_CHARACTER_SPIN(WDES1, W_NEW%GPROJ(:,N,NK,ISP), PKPOINTS_TRANS%RSSYMOP(:,:,NK))
...
! store the difference vector between rotated and original k-point
      ...
      ENDDO
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
! Here 1._q could add the additional use of time reversal symmetry
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
