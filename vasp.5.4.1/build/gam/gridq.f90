...
!
! 1._q major complication is that quantities
...
!***********************************************************************
  ...
  TYPE gridquant
     ...
     REAL(q), POINTER      :: RG(:,:)   ! pointer to the same storage position (rgrid)
...
!=======================================================================
!
! set unbalanced lattice vectors to 0._q
!
!=======================================================================
...
! first dimension is N1 second 1._q N2
!
!=======================================================================
