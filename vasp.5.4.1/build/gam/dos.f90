...
!***********************************************************************
  ...
  CONTAINS
    SUBROUTINE DENMP(IU0, WDES, ISPIN, RSPIN, EMIN, EMAX, EFERMI_FORCE, & 
      ...
      REAL(q) FERWE(:,:,:)            ! occupancies of 1._q electron states
...
! the density of states (1._q of the secret flag settings in VASP ...)
...
!
! this version returns two Fermi-levels, 1._q for spin up and
! 1._q for spin down in EFERMI(ISPIN)
!
!***********************************************************************
