...
! to the 1._q center magnetization are truncated in the non collinear case
...
! contributions to the 1._q center magnetisation are projected onto the
...
! from 1._q of the grid points (due to rounding errors on reading)
!
!*******************************************************************
...
! quantum numbers l and lp of these two channels
         ...
         LLP=L(CH2)
         IF (LL == LLP) THEN
! here 1._q has to calculate the spherical contribution
...
!
!  RAD_GGA_ASPH
! calculate the 1._q center exchange energy and the potential
...
! the following lines cause sizeable errors in the 1._q-electron energies e.g. for
...
! additional factor r stems from logarithmic grid
      ...
      ENDDO
      H3=R%H/ 3.0_q
! integrate inward (assuming 0._q moment for grid point NMAX)
...
!  this energy will be subtracted (definining the 0._q of energy)
