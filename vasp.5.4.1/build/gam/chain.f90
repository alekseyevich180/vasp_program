...
! and the VCA tag is set for 1._q type to 0 and 1 respectively
...
! 0._q out any added forces on frozen atoms
      force = force*Free
...
! Make vector to 0._q out force on frozen atoms
...
! if 1._q node is .FALSE., .FALSE. is returned on all nodes
      IF (value) THEN
         sum=0
      ELSE
         sum=1
