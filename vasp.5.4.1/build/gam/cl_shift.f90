...
! pseudopotential (i.e. by increasing its valency by 1._q)
!
...
!  calculated core level shifts
    ...
    REAL(q),ALLOCATABLE,SAVE :: CHTEST(:)
...
! and ideally afterwards 1._q should clearup with CL_CLEAR_CORE_CONF
!
!*******************************************************************
...
! set wave function to 0._q beyond KJ
...
! as test charge either the 1._q normaliued augmentation charges (PAW)
...
! such that its ionicity is increased by 1._q.
! ) first the routine AUGTOQ is called to determine
!   the fourier transform of a 1._q normalised test charge
...
! as test charge either the 1._q normalized augmentation charges (PAW)
! or a spherical test charge with an automatically chosen
! radius is used (NC, US-PP)
!
!*******************************************************************
