...
! so we can interchange both arrays arbitrarily
     ...
     &            DENCOR,DWORKG,DWORK1,DWORK2,DWORK3,DVC)
      ...
      REAL(q)   DHTOT(GRIDC%MPLWV*2,NCDIJ),DWORK(GRIDC%MPLWV*2,NCDIJ), &
              DWGRAD(GRIDC%MPLWV*2,NCDIJ)
      REAL(q)   DENCOR(GRIDC%RL%NP)
      REAL(q) XCSIF(3,3)
