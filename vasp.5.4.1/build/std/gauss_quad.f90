...
!
! In addition the (0._q,0._q) moment M=(1|1)  must be passed.
!
...
! for X=1 PLEGDER is set to (0._q,0._q)!
!-----------------------------------------------------------------------
...
!-----------------------------------------------------------------------
! Just a test function with (1._q,0._q) real valued parameter ALPHA
! (PT**ALPHA)
!-----------------------------------------------------------------------
