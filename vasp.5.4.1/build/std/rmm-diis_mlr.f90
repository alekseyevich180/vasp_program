...
!COVL(i,j)=<phi(0)_i|S|w1_j>
       ...
       IF (WDES1%NPL_RED/=0) THEN
          ...
          DO NPOSB1=1,NDO,NSTRPB; DO NPOSB2=1,WDES1%NB_TOT,NSTRPB
             CALL ZGEMM('C','N',MIN(NSTRPB,WDES1%NB_TOT-NPOSB2+1),MIN(NSTRPB,NDO-NPOSB1+1), WDES1%NPL_RED, &
            &   (1._q,0._q),SW0_RED(1,NPOSB2), NRPLWV_RED,CW1_RED(1,NPOSB1), NRPLWV_RED,(0._q,0._q),COVL(NPOSB2,NPOSB1),WDES1%NB_TOT)
          ENDDO; ENDDO
# 494
...
# 500
       ...
       CALL M_sum_z(WDES1%COMM_KIN,COVL(1,1),NSIM*NCPU*WDES1%NB_TOT)
# 506

! set COVL(i,j)=0 if |phi(0)_i> is an empty state.
       DO NP=1,WDES1%NB_TOT
          IF (W0%FERTOT(NP,NK,ISP)<1E-4_q) COVL(NP,:)=(0._q,0._q)
       ENDDO
# 513
...
! subtract |phi(0)_j><phi(0)_j|S|phi(1)_i> from |phi(1)_i>
       IF (WDES1%NPL_RED/=0) THEN
          NDO=MIN(NSIM*NCPU,WDES1%NB_TOT)
          NSTRPB=NDO; NSTRPL= WDES1%NPL_RED
          DO NPOSB1=1,NDO,NSTRPB; DO NPOSPL=1, WDES1%NPL_RED,NSTRPL
             CALL ZGEMM('N','N',MIN(NSTRPL, WDES1%NPL_RED-NPOSPL+1),MIN(NSTRPB,NDO-NPOSB1+1),WDES1%NB_TOT, &
            &   -(1._q,0._q),W0%CPTWFP(NPOSPL,1,NK,ISP), NRPLWV_RED,COVL(1,NPOSB1),WDES1%NB_TOT,(1._q,0._q),CW1_RED(NPOSPL,NPOSB1), NRPLWV_RED)
          ENDDO; ENDDO
# 524
...
!COVL(i,j)=<phi(0)_i|wacc_j>
       ...
       IF (WDES1%NPL_RED/=0) THEN
          ...
          DO NPOSB1=1,NDO,NSTRPB; DO NPOSB2=1,WDES1%NB_TOT,NSTRPB
             CALL ZGEMM('C','N',MIN(NSTRPB,WDES1%NB_TOT-NPOSB2+1),MIN(NSTRPB,NDO-NPOSB1+1), WDES1%NPL_RED, &
            &   (1._q,0._q),W0%CPTWFP(1,NPOSB2,NK,ISP), NRPLWV_RED,WACC%CW_RED(1,NPOSB1), NRPLWV_RED,(0._q,0._q),COVL(NPOSB2,NPOSB1),WDES1%NB_TOT)
          ENDDO; ENDDO
# 607
...
! subtract S|phi(0)_j><phi(0)_j|wacc_i> from |wacc_i>
       IF (WDES1%NPL_RED/=0) THEN
          ...
          DO NPOSB1=1,NDO,NSTRPB; DO NPOSPL=1, WDES1%NPL_RED,NSTRPL
             CALL ZGEMM('N','N',MIN(NSTRPL, WDES1%NPL_RED-NPOSPL+1),MIN(NSTRPB,NDO-NPOSB1+1),WDES1%NB_TOT, &
            &   -(1._q,0._q),SW0_RED(NPOSPL,1), NRPLWV_RED,COVL(1,NPOSB1),WDES1%NB_TOT,(1._q,0._q),WACC%CW_RED(NPOSPL,NPOSB1), NRPLWV_RED)
          ENDDO; ENDDO
# 637
