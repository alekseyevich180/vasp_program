...
!=======================================================================
    ...
    REAL(q)  CRHODE(LMDIM,LMDIM,WDES%NIONS,WDES%NCDIJ)  ! (1._q,0._q) center occupancies
    REAL(q)  CRHODE1(LMDIM,LMDIM,WDES%NIONS,WDES%NCDIJ) ! derivative of (1._q,0._q) center occupancies
