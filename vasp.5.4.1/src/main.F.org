...
!=======================================================================
      ...
      CHARACTER (LEN=80),PARAMETER :: VASP = &
        'vasp.5.4.1' // ' ' // &
        '05Feb16' // ' (build ' // __DATE__// ' ' //__TIME__// ') ' // &
        'gamma-only'
#else
      CHARACTER (LEN=80),PARAMETER :: VASP = &
        'vasp.5.4.1' // ' ' // &
...
#if defined(CUDA_GPU) && defined(USE_PINNED_MEMORY)
      CALL nvpinnedmalloc(SV_PTR,DIMREAL(GRID%MPLWV)*NCDIJ*sizeof(fake)) 
      CALL c_f_pointer(SV_PTR,SV,(/DIMREAL(GRID%MPLWV),NCDIJ/))
! charges, potentials and so on
      CALL nvpinnedmalloc(CHTOT_PTR, GRIDC%MPLWV * NCDIJ*sizeof(fakec))
...
!=======================================================================
#ifdef CUDA_GPU
      nv_profile_start(NVP_VASP_SPHER)
#endif
...
#ifdef CUDA_GPU
      nv_profile_stop(NVP_VASP_SPHER)
#endif
!=======================================================================
...
!=======================================================================
#ifdef CUDA_GPU
      nv_profile_start(NVP_VASP_DENINI)
#endif
...
!=======================================================================
      ...
      ENDIF
#ifdef CUDA_GPU
      nv_profile_stop(NVP_VASP_DENSTA)
#endif
!=======================================================================
...
!=======================================================================
#ifdef CUDA_GPU
      nv_profile_start(NVP_VASP_SETDIJ)
#endif
      ...
      DWRITE0 'setdij done'
#ifdef CUDA_GPU
      nv_profile_stop(NVP_VASP_SETDIJ)
      nv_profile_start(NVP_VASP_PROALL)
#endif
...
#ifdef CUDA_GPU
      nv_profile_stop(NVP_VASP_PROALL) 
      nv_profile_start(NVP_VASP_ORTHCH)
#endif
      ...
      DWRITE0 'orthch done'
#ifdef CUDA_GPU
      nv_profile_stop(NVP_VASP_ORTHCH)
#endif
...
!=======================================================================
#ifdef CUDA_GPU
      nv_profile_start(NVP_VASP_PARDENS)
#endif
      IF (LPARD) THEN
           CALL DENSTA( IO%IU0, IO%IU6, WDES, W, KPOINTS, INFO%NELECT, &
                INFO%NUP_DOWN,  E%EENTROPY, EFERMI, KPOINTS%SIGMA, .FALSE., &
      ...
      ENDIF
#ifdef CUDA_GPU
      nv_profile_stop(NVP_VASP_PARDENS)
#endif
!=======================================================================
...
!=======================================================================
#ifdef CUDA_GPU
      nv_profile_start(NVP_VASP_CHARGEDEN)
#endif
      IF (INFO%INICHG==0 .OR. INFO%INICHG==4 .OR. (.NOT.INFO%LCHCOS .AND. INFO%NELMDL==0)  ) THEN
         IF (IO%IU6>=0) &
      ...
      ENDIF
#ifdef CUDA_GPU
      nv_profile_stop(NVP_VASP_CHARGEDEN)
#endif
!=======================================================================
...
!=======================================================================
#ifdef CUDA_GPU
      nv_profile_start(NVP_VASP_WAVPRE)
#endif
...
#ifdef CUDA_GPU
      nv_profile_stop(NVP_VASP_WAVPRE)
#endif
!=======================================================================
...
!=======================================================================
      CALL START_TIMING("G")
#ifdef CUDA_GPU
      nv_profile_start(NVP_VASP_EWALD)
#endif
      IF(INFO%TURBO==0) THEN
      ...
      ENDIF
#ifdef CUDA_GPU
      nv_profile_stop(NVP_VASP_EWALD)
#endif
...
!=======================================================================
#ifdef CUDA_GPU
      nv_profile_start(NVP_VASP_CALCSV)
#endif
      INFO%LPOTOK=.FALSE.
      TOTENG=0
      INFO%LSTOP=.FALSE.
      ...
      ENDIF
#ifdef CUDA_GPU
      nv_profile_stop(NVP_VASP_CALCSV)
#endif
!=======================================================================
...
!=======================================================================
      ...
      IF (LTIME_EVOLUTION) THEN         
         CALL  CALCULATE_TIME_PROPAGATION( &
              ...
              NBANDSO, NBANDSV, OMEGAMAX, SHIFT, NELM, & 
      ...
      IF (LCHI) THEN
         ...
         ENDIF
#ifdef vasp6
         IF (ICHIREAL==1 .OR. (ICHIREAL>=1 .AND. WDES%LGAMMA) ) THEN
            CALL CALCULATE_XI_REAL_ADFTRK( & 
...
#ifdef CUDA_GPU	
      nv_profile_start(NVP_VASP_IONLOOP)
#endif
!=======================================================================
      ion: DO
...
!***********************************************************************
#ifdef CUDA_GPU
      nv_profile_start(NVP_IONLOOP_ELMIN)
#endif
      ...
      ENDIF
#ifdef CUDA_GPU
      nv_profile_stop(NVP_IONLOOP_ELMIN)
#endif
...
#ifdef VASP2WANNIER90
      IF ((.NOT.(KINTER/=0)).AND.(.NOT.L2E4W)) THEN
         CALL KPAR_SYNC_ALL(WDES,W)
         CALL MLWF_WANNIER90(WDES,W,P,CQIJ,T_INFO,LATT_CUR,INFO,IO)
      ENDIF
#endif
...
#ifdef CUDA_GPU
      nv_profile_start(NVP_IONLOOP_FSTRESS)
#endif
...
#ifdef CUDA_GPU
      nv_profile_stop(NVP_IONLOOP_FSTRESS)
#endif
      ENDIF
...
ibrion: IF (DYN%IBRION==0) THEN
        ...
        !tb end
         ...
         CALLMPI ( M_bcast_i(WDES%COMM, SEED, K_SEED) )
         CALL RANDOM_SEED(PUT= SEED(1 : K_SEED))
...
! next electronic energy minimisation
    ...
    END IF !LJ_ONLY
      ...
      ENDDO ion
#ifdef CUDA_GPU
      nv_profile_stop(NVP_VASP_IONLOOP)
#endif
!=======================================================================
