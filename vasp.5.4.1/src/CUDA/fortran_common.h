...
#define CUBLAS_RESET_ST         cublas_reset_st_
#define THREADSYNCHRONIZE       threadsynchronize_
#define CUDA_ALL_STREAM_SYNCHRONIZE cuda_all_stream_synchronize_
#define CUBLAS_SHUTDOWN         cublas_shutdown_
#define CUBLAS_ALLOC            cublas_alloc_
#define CUBLAS_ALLOC_SAFETY     cublas_alloc_safety_
#define CUBLAS_FREE             cublas_free_
#define CUBLAS_FREE_SAFETY      cublas_free_safety_
#define MAX_GPU_MEMORY          max_gpu_memory_
#define PRINT_GPU_ALLOC         print_gpu_alloc_
#define PRINT_GPU_MEMORY        print_gpu_memory_
#define PERCENT                 percent_
#define GET_GPU_MAX_MEMORY      get_gpu_max_memory_
#define CUBLAS_SET_VECTOR       cublas_set_vector_
#define CUBLAS_SET_VECTOR_ASYNC cublas_set_vector_async_
#define CUBLAS_SET_VECTOR_ST cublas_set_vector_st_
#define CUBLAS_SET_VECTOR_SHZ   cublas_set_vector_shz_
#define CUBLAS_GET_VECTOR       cublas_get_vector_
#define CUBLAS_GET_VECTOR_ASYNC cublas_get_vector_async_
#define CUBLAS_GET_VECTOR_ST cublas_get_vector_st_
#define CUBLAS_GET_VECTOR_SH_ASYNC cublas_get_vector_sh_async_
#define CUBLAS_GET_VECTOR_SH       cublas_get_vector_sh_
#define CUBLAS_GET_VECTOR_SHZ   cublas_get_vector_shz_
#define CUBLAS_SET_MATRIX       cublas_set_matrix_
#define CUBLAS_SET_MATRIX_SHIFT cublas_set_matrix_shift_
#define CUBLAS_SET_MATRIX_ASYNC cublas_set_matrix_async_
#define CUBLAS_GET_MATRIX       cublas_get_matrix_
#define CUBLAS_GET_MATRIX_SHZ   cublas_get_matrix_shz_
...
#define CUBLAS_DAXPY_ST         cublas_daxpy_st_
...
#define CUBLAS_ZGEMMSH          cublas_zgemmsh_
#define CUBLAS_ZGEMMSH_ST       cublas_zgemmsh_st_
#define CUBLAS_DGEMMSH          cublas_dgemmsh_
#define CUBLAS_DGEMMSH_ST       cublas_dgemmsh_st_
#define CUBLAS_ZGEMV_SHIFT      cublas_zgemv_shift_
#define CUBLAS_ZDOTC_SHIFT      cublas_zdotc_shift_
#define CUBLAS_ZSCAL_SHIFT      cublas_zscal_shift_
#define CUBLAS_DAXPY_SHIFT      cublas_daxpy_shift_
#define CUBLAS_ZAXPY_SHIFT      cublas_zaxpy_shift_
...
#define THREADSYNCHRONIZE       THREADSYNCHRONIZE
#define CUDA_ALL_STREAM_SYNCHRONIZE CUDA_ALL_STREAM_SYNCHRONIZE 
#define CUBLAS_SHUTDOWN         CUBLAS_SHUTDOWN
#define CUBLAS_ALLOC            CUBLAS_ALLOC
#define CUBLAS_ALLOC_SAFETY     CUBLAS_ALLOC_SAFETY
#define MAX_GPU_MEMORY          MAX_GPU_MEMORY
#define PRINT_GPU_ALLOC         PRINT_GPU_ALLOC
#define PRINT_GPU_MEMORY        PRINT_GPU_MEMORY
#define PERCENT                 PERCENT
#define GET_GPU_MAX_MEMORY      GET_GPU_MAX_MEMORY
#define CUBLAS_FREE             CUBLAS_FREE
#define CUBLAS_FREE_SAFETY      CUBLAS_FREE_SAFETY
#define CUBLAS_SET_VECTOR       CUBLAS_SET_VECTOR
#define CUBLAS_SET_VECTOR_SHZ   CUBLAS_SET_VECTOR_SHZ
#define CUBLAS_GET_VECTOR       CUBLAS_GET_VECTOR
#define CUBLAS_GET_VECTOR_SHZ   CUBLAS_GET_VECTOR_SHZ
#define CUBLAS_SET_MATRIX       CUBLAS_SET_MATRIX
#define CUBLAS_SET_MATRIX_SHIFT CUBLAS_SET_MATRIX_SHIFT
#define CUBLAS_SET_MATRIX ASYNC CUBLAS_SET_MATRIX_ASYNC
#define CUBLAS_GET_MATRIX       CUBLAS_GET_MATRIX
#define CUBLAS_GET_MATRIX_SHZ   CUBLAS_GET_MATRIX_SHZ
...
#define CUBLAS_DAXPY_ST         CUBLAS_DAXPY_ST
...
#define CUBLAS_ZGEMMSH          CUBLAS_ZGEMMSH
#define CUBLAS_ZGEMMSH_ST       CUBLAS_ZGEMMSH_ST
#define CUBLAS_DGEMMSH          CUBLAS_DGEMMSH
#define CUBLAS_RESET_ST         CUBLAS_RESET_ST
#define CUBLAS_ZGEMV_SHIFT      CUBLAS_ZGEMV_SHIFT
#define CUBLAS_ZDOTC_SHIFT      CUBLAS_ZDOTC_SHIFT
#define CUBLAS_ZSCAL_SHIFT      CUBLAS_ZSCAL_SHIFT
#define CUBLAS_DAXPY_SHIFT      CUBLAS_DAXPY_SHIFT
#define CUBLAS_ZAXPY_SHIFT      CUBLAS_ZAXPY_SHIFT
